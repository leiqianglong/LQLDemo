...
@implementation QLDataController
...
- (void)viewDidLoad {
    ...
    UIBarButtonItem *item2 = [[UIBarButtonItem alloc] initWithTitle:@"车库" style:UIBarButtonItemStylePlain target:self action:@selector(watchCars)];
