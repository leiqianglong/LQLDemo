...
//        [self.headBgView addSubview:label];
        ...
        self.back.frame=CGRectMake(5,CGRectGetMaxY(frame)-44, 44, 44);
        [self.back addTarget:self action:@selector(backClick) forControlEvents:UIControlEventTouchUpInside];
        [self addSubview:self.back];
        
        self.backgroundColor=[UIColor clearColor];
        self.label=[[UILabel alloc]initWithFrame:CGRectMake(44, CGRectGetMaxY(frame)-44, frame.size.width-44-44, 44)];
        ...
        self.rightBtn.frame = CGRectMake(self.frame.size.width-46, CGRectGetMaxY(frame)-44, 44, 44);
