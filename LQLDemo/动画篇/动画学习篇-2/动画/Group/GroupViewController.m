...
- (void)sameTimeAnimation {
    ...
    NSValue *value1 = [NSValue valueWithCGPoint:CGPointMake(50, kWidth/2-50)];
    NSValue *value2 = [NSValue valueWithCGPoint:CGPointMake(kWidth/3, kHeight/2-50)];
    NSValue *value3 = [NSValue valueWithCGPoint:CGPointMake(kWidth/3, kHeight/2+50)];
    NSValue *value4 = [NSValue valueWithCGPoint:CGPointMake(kWidth*2/3, kHeight/2+50)];
    NSValue *value5 = [NSValue valueWithCGPoint:CGPointMake(kWidth*2/3, kHeight/2-50)];
    NSValue *value6 = [NSValue valueWithCGPoint:CGPointMake(kWidth-50, kHeight/2-50)];
...
- (void)continueAnimation {
    ...
    positionAnimation.fromValue = [NSValue valueWithCGPoint:CGPointMake(50, kHeight/2)];
    positionAnimation.toValue = [NSValue valueWithCGPoint:CGPointMake(kWidth/2, kHeight/2)];
